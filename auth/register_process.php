<?php
session_start();
require_once '../config/connect.php'; // This include path was already fixed
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt_insert) {
        $stmt_insert->bind_param("ssssii", $name, $email, $hashed_password, $role, $department_id, $campus_id); 
