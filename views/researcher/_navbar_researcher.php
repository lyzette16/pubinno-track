<?php
// File: views/researcher/_navbar_researcher.php
...
if ($researcher_user_id > 0 && isset($conn)) {
    ...
    if ($stmt_notif_count) {
        ...
        error_log("Failed to prepare statement for fetching notification count in navbar: " . $conn->error);
    }
}
?>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm py-3">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold text-primary" href="#">
            <i class="bi bi-journal-bookmark-fill me-2"></i>PubInno-track: Researcher Panel
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link px-3 <?= (basename($_SERVER['PHP_SELF']) == 'submit.php') ? 'active text-primary fw-semibold' : '' ?>" href="submit.php">Submit Work</a>
                </li>
                <li class="nav-item">
                    <!-- Corrected link to track.php -->
                    <a class="nav-link px-3 <?= (basename($_SERVER['PHP_SELF']) == 'track.php') ? 'active text-primary fw-semibold' : '' ?>" href="track.php">Track Submission</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3 <?= (basename($_SERVER['PHP_SELF']) == 'my_submissions.php') ? 'active text-primary fw-semibold' : '' ?>" href="my_submissions.php">My Submissions</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item me-3">
                    <a class="nav-link text-dark fw-semibold d-flex align-items-center p-0" href="profile.php" title="View Profile">
                        ...
                        Welcome, <?= htmlspecialchars(str_replace('*', '', $_SESSION['username'] ?? 'Researcher')) ?>
                    </a>
                </li>
